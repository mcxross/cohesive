...
class CohesiveProcessor(private val environment: SymbolProcessorEnvironment) : BaseProcessor(environment) {
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        if (!symbols.iterator().hasNext()) {
            ...
            e("More than one class annotated with @Cohesive found. Only one class can be annotated with @Cohesive")
            return emptyList()
        }
