...
annotation class Extension(
  val ordinal: Int = 0,
  /**
   * An array of extension points, that are implemented by this extension. This explicit
   * configuration overrides the automatic detection of extension points in the
   * [xyz.mcxross.cohesive.csp.processor.ExtensionProcessor].
   *
   * In case your extension is directly derived from an extension point this attribute is NOT
   * required. But under certain [more complex scenarios](https://github.com/pf4j/pf4j/issues/264)
   * it might be useful to explicitly set the extension points for an extension.
   *
