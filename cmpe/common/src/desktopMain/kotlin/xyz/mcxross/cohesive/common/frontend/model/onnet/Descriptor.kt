...
import xyz.mcxross.cohesive.common.frontend.utils.getHTTPClient
...
object Descriptor {
  ...
  private var secondaryPlugins: ArrayList<xyz.mcxross.cohesive.common.frontend.model.SecondaryPlugin> = arrayListOf()
  fun run(): Descriptor {
  ...
  private suspend fun chainFlow(): Flow<xyz.mcxross.cohesive.common.frontend.model.SecondaryPlugin> = flow {
    var jsonResp = ""
    ...
    parse(jsonResp).jsonObject["chain"]?.jsonArray?.shuffled()?.forEach {
      emit(
        xyz.mcxross.cohesive.common.frontend.model.SecondaryPlugin(
  ...
  fun getPlugins(): List<xyz.mcxross.cohesive.common.frontend.model.SecondaryPlugin> {
