...
open class CompositeExtensionFinder(val pluginManager: PluginManager) :
   ...
   */
  private var finders: MutableList<ExtensionFinder> =
    mutableListOf(LegacyExtensionFinder(pluginManager))
   ...
   * [xyz.mcxross.cohesive.csp.annotation.Extension] class.
   *
   * @param type the [xyz.mcxross.cohesive.csp.annotation.Extension] class
  ...
  /**
   * Find a list of [ExtensionWrapper]s for the given
   * [xyz.mcxross.cohesive.csp.annotation.Extension] class and [Plugin] id.
   *
   * @param type the [xyz.mcxross.cohesive.csp.annotation.Extension] class
