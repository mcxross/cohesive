...
import xyz.mcxross.cohesive.designsystem.mellow.Platform
import xyz.mcxross.cohesive.designsystem.mellow.fastFold
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.MappedKeys
...
internal fun isCopyKeyEvent(keyEvent: KeyEvent) =
  keyEvent.key == MappedKeys.C && when (Platform.Current) {
    Platform.MacOS -> keyEvent.isMetaPressed
