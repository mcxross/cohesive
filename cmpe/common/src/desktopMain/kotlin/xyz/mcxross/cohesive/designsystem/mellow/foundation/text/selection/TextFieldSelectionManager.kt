...
package xyz.mcxross.cohesive.designsystem.mellow.foundation.text.selection
...
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.HandleState
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.TextDragObserver
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.TextFieldState
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.UndoManager
import xyz.mcxross.cohesive.designsystem.mellow.foundation.text.detectDragGesturesWithObserver
  ...
  internal fun handleDragObserver(isStartHandle: Boolean): TextDragObserver {
    return object : TextDragObserver {
      override fun onStart(startPoint: Offset) {
        ...
        dragBeginPosition = getAdjustedCoordinates(
