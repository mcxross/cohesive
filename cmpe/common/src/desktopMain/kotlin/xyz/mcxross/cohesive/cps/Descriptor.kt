...
import xyz.mcxross.cohesive.utils.getHTTPClient
...
object Descriptor {
  ...
  private var secondaryPlugins: ArrayList<SecondaryPlugin> = arrayListOf()
  fun run(): Descriptor {
  ...
  private suspend fun chainFlow(): Flow<SecondaryPlugin> = flow {
    var jsonResp = ""
  ...
  fun getPlugins(): List<SecondaryPlugin> {
