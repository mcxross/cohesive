...
class DevelopmentPluginClasspath : PluginClasspath() {
  ...
  companion object {
    /**
     * The development Plugin classpath for [Maven](https://maven.apache.org). The classes
    ...
    /**
     * The development Plugin classpath for [Gradle](https://gradle.org). The classes
    ...
    /**
     * The development Plugin classpath for [Kotlin](https://kotlinlang.org). The classes
    ...
    /**
     * The development Plugin classpath for
